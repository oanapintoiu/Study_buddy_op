...
const Sidebar = ({ navigate }) => {
  ...
  return (
    <div className="sidebar">
      ...
      <a href="/posts" className="side-bar-item">
        <i className="fa fa-home"></i> Home
      </a>

      <a href="/profile" className="side-bar-item">
        <i className="fa fa-user"></i> Profile
      </a>

      <div className="dropdown">
        <div className="dropbtn">
          <i className="fa fa-tools"></i> Tools
        </div>
        <div className="dropdown-content">
          <a target="_blank" href="https://miro.com/">
            Miro
          </a>
          ...
          <a target="_blank" href="https://pomofocus.io/">
            Pomodoro
          </a>
        </div>
      </div>
      ...
      <div className="study-groups">
        <div className="group-title">
          <i className="fa-solid fa-user-group"></i> Study Groups
        </div>
